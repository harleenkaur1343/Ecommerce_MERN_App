          ...
          >
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary border border-primary/20 w-fit">
                ...
                <span className="text-[10px] font-bold tracking-widest uppercase">Top Rated Choice</span>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-sm text-primary font-bold underline underline-offset-4">124 Reviews</span>
              </div>
              <p className="text-3xl font-display font-bold text-foreground mt-4">${product.price.toFixed(2)}</p>
            </div>
            ...
            <div className="space-y-6 pt-6 border-t border-primary/5">
              <div className="flex items-center gap-6">
                ...
                <Button variant="outline" size="icon" className="rounded-full w-12 h-12 border-primary/10">
                  <Heart className="w-5 h-5" />
                </Button>
              </div>

              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="flex-1 h-16 rounded-full bg-primary hover:bg-primary/90 text-white font-bold text-lg shadow-xl shadow-primary/20 group">
                  Add to Ritual
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">30-day organic guarantee</p>
                </div>
              </div>
            </div>
          </motion.div>
