        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg md:text-xl max-w-[500px] leading-relaxed">
              Experience the transformative power of botanical extracts. Our
              minimalist formulas respect your skin's natural balance.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mt-2">
              <Button
                ...
                size="lg"
                className="rounded-full px-10 h-14 text-base font-semibold bg-primary hover:bg-primary/90 shadow-xl shadow-primary/20 transition-all hover:scale-105"
              >
              ...
              <Button
                ...
                variant="link"
                size="lg"
                className="h-14 text-foreground font-semibold group"
              >
                Our Rituals{" "}
